...
class PackagingTests(unittest.TestCase):
    ...
    def test_release_version_and_merged_font_are_packaged(self):
        ...
        self.assertIn('!define APPVERSION "1.4.2"', installer)
        self.assertIn('VIProductVersion "1.4.2.0"', installer)
        self.assertTrue(release_notes.startswith("TCRC Youtso Unicode 1.4.2"))
